...
可以看到在`ent/migrate/migrations/`目录下创建了名为`20221115101649_add_user_title.sql`的新文件。该文件包含用于在`users`表中创建新增`title`字段的SQL语句：
...
成功！我们已使用Atlas CLI自动为变更生成了新的迁移文件。
